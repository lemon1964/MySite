...
class PostHome(DataMixin, ListView):
    ...
    title_page = 'Главная страница статей'
    cat_selected = 0
...
class PostShare(FormView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('posts:post_share', kwargs={'post_id': self.kwargs['post_id']}) + f"?sent={self.sent}&to={email}"
...
class AddComment(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('posts:post_comments', kwargs={'post_id': post_id})
